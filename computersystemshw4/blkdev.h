/*
 * file:        blkdev.h
 * description: Block device structure for CS 5600 HW3
 *
 * Peter Desnoyers, Northeastern Computer Science, 2011
 * $Id: blkdev.h 454 2011-11-28 23:02:54Z pjd $
 */
#ifndef __BLKDEV_H__
#define __BLKDEV_H__

#define SECTOR_SIZE 512   /* 512-byte unit for all blkdev addressing in HW3 */
...
extern struct blkdev *striped_create(int, struct blkdev **, int);
extern struct blkdev *raid4_create(int, struct blkdev **, int);
extern int raid4_replace(struct blkdev *, int, struct blkdev *);
extern struct blkdev *raid5_create(int, struct blkdev **, int);
extern int raid5_replace(struct blkdev *, int, struct blkdev *);
